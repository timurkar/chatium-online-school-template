...
const Lessons = Heap.Table('t_school_lessons_N4RD', {
  ...
  videoHash: Heap.Optional(Heap.String({ customMeta: { title: 'Видео из хранилища Chatium (хеш файла)' } })),
  videoUrl: Heap.Optional(Heap.String({ customMeta: { title: 'Или внешняя ссылка на видео (YouTube, VK, Rutube, mp4)' } })),
